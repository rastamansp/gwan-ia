      ...
      <main className="container py-20">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-12">
            Acesse um conjunto completo de ferramentas de inteligência
            artificial projetadas para acelerar seu trabalho e criatividade.
          </p>
        </div>
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {/* Chatbot Inteligente */}
            <div className="bg-card rounded-xl p-6 border border-border hover:border-border/80 transition-all duration-300 hover:shadow-elevated hover:-translate-y-2 flex flex-col h-full">
              ...
              <p className="text-muted-foreground text-sm mb-4 flex-grow">
                Conversas naturais com IA avançada
              </p>
              <div
                onClick={() =>
                  alert(
            ...
            <div className="bg-card rounded-xl p-6 border border-border hover:border-border/80 transition-all duration-300 hover:shadow-elevated hover:-translate-y-2 flex flex-col h-full">
              ...
              <p className="text-muted-foreground text-sm mb-4 flex-grow">
                Traduza entre 100+ idiomas instantaneamente
              </p>
              <div
                onClick={() =>
                  alert(
            ...
            <div className="bg-card rounded-xl p-6 border border-border hover:border-border/80 transition-all duration-300 hover:shadow-elevated hover:-translate-y-2 flex flex-col h-full">
              ...
              <p className="text-muted-foreground text-sm mb-4 flex-grow">
                Crie imagens únicas com descrições de texto
              </p>
              <div
                onClick={() =>
                  alert(
            ...
            <div className="bg-card rounded-xl p-6 border border-border hover:border-border/80 transition-all duration-300 hover:shadow-elevated hover:-translate-y-2 flex flex-col h-full">
              ...
              <p className="text-muted-foreground text-sm mb-4 flex-grow">
                Produza vídeos impressionantes com IA
              </p>
              <div
                onClick={() =>
                  alert(

      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-800 rounded-lg border border-gray-700 p-6 hover:border-purple-500 transition-colors duration-200 cursor-pointer">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Criar Nova IA</h3>
            <p className="text-gray-400 text-sm">Configure uma nova ferramenta de IA personalizada</p>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">IA de Suporte</h3>
            <p className="text-gray-400 text-sm">Assistente para atendimento ao cliente</p>
          ...
          <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
            ...
            <p className="text-gray-400 text-sm">Visualize o desempenho das suas IAs</p>
            <div className="mt-4">

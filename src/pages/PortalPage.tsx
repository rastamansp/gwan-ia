...
const features = [
  {
    title: 'Notícias e posts',
    description:
      'Acompanhe a cena reggae e a cultura com conteúdo sempre atualizado.',
    icon: Newspaper,
  },
  {
    title: 'Loja integrada',
    description: 'Produtos e novidades da comunidade em um só lugar.',
    icon: ShoppingBag,
  },
  {
    title: 'Eventos',
    description: 'Agenda, shows e programação cultural com inscrição online.',
    icon: CalendarDays,
  },
  {
    title: 'Rádio ao vivo',
    description: 'Streaming da Gwan Reggae Radio (AzuraCast) direto no portal.',
    icon: Radio,
  },
  {
    title: 'Comunidade e social',
    description: 'Conecte-se com a comunidade e compartilhe a vibe.',
    icon: Users,
  },
  {
    title: 'Suporte dedicado',
    description: 'Atendimento próximo para acompanhar você em cada etapa.',
    icon: Headphones,
  },
];
          ...
          <div className="container relative z-10">
            <div className="mx-auto max-w-3xl space-y-8 text-center animate-fade-in">
              <div className="inline-flex items-center gap-2 rounded-full border border-amber-500/20 bg-amber-500/10 px-4 py-2 text-sm font-medium text-amber-600 backdrop-blur-sm dark:text-amber-400">
                ...
                Portal de cultura e entretenimento
              </div>
              ...
              <p className="mx-auto max-w-2xl text-xl leading-relaxed text-muted-foreground">
                Portal de cultura reggae e entretenimento. Notícias, loja,
                eventos, rádio ao vivo e comunidade — tudo em um só lugar.
              </p>

              <div className="flex flex-col justify-center gap-4 pt-2 sm:flex-row">
                <Button size="lg" className="group text-lg" asChild>
                  <a
                    href={env.VITE_GWAN_PORTAL_URL}
                    target="_blank"
          ...
          <div className="container mx-auto">
            <div className="mb-16 space-y-4 text-center">
              ...
              <p className="mx-auto max-w-2xl text-xl text-muted-foreground">
                Cultura, comunidade e entretenimento reunidos
              </p>
            </div>

    ...
    <div className="min-h-screen bg-gray-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <nav className="flex space-x-8">
              <Link
                to="/"
                className="text-gray-mutedText hover:text-accent-primary font-medium"
              >
                🏠 Home
              </Link>
              <Link to="/theme" className="text-accent-primary font-medium">
                🎨 Tema
              </Link>
              <Link
                to="/auth"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-black mb-4">
            🎨 Sistema de Design
          </h2>
          <p className="text-xl text-gray-mutedText max-w-3xl mx-auto">
            Explore nosso sistema de design completo com cores semânticas,
            componentes reutilizáveis e tokens de design baseados no Radix UI
            Themes.
          </p>
        </div>
        ...
        <section className="mb-16">
          <h3 className="text-2xl font-bold text-gray-black mb-8">
            🎨 Seletor de Temas
          </h3>

          <div className="bg-white rounded-xl border border-gray-border p-8">
            <div className="text-center mb-6">
              <h4 className="text-lg font-semibold text-gray-black mb-2">
              ...
              {Object.values(themes).map(theme => (
                ...
                >
                  <div className="text-center">
                    <div
                      className="w-16 h-16 mx-auto mb-3 rounded-lg flex items-center justify-center text-white font-bold text-lg"
                      style={{ backgroundColor: theme.colors.primary }}
                    >
                      {theme.name.charAt(0)}
                    </div>
                    <h5 className="font-semibold text-gray-black mb-1">
                      {theme.name}
                    </h5>
                    <p className="text-sm text-gray-mutedText">
                      {theme.description}
                    </p>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl border border-gray-border p-6">
              <h4 className="font-semibold text-gray-black mb-4">
                Accent (Primárias)
              </h4>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <code className="text-xs text-gray-strongText">
                      accent-primary
                    </code>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-mutedText">
                    primaryHover
                  </span>
                  <div className="flex items-center space-x-2">
            ...
            <div className="bg-white rounded-xl border border-gray-border p-6">
              ...
              <div className="space-y-3">
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-border rounded-lg focus:ring-2 focus:ring-accent-primary focus:border-accent-border transition-colors"
                />
                <input
                  type="email"
                  placeholder="Email com erro"
                  className="w-full px-3 py-2 border border-error-primary rounded-lg focus:ring-2 focus:ring-error-primary focus:border-error-primaryHover bg-error-background transition-colors"
                />
              </div>
            </div>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="bg-white rounded-xl border border-gray-border p-8">
            <div className="space-y-4">
              <h1 className="text-4xl font-bold text-gray-black">
                Título H1 - Inter Bold
              </h1>
              <h2 className="text-3xl font-semibold text-gray-black">
                Título H2 - Inter Semibold
              </h2>
              <h3 className="text-2xl font-medium text-gray-black">
                Título H3 - Inter Medium
              </h3>
              <h4 className="text-xl font-medium text-gray-black">
                Título H4 - Inter Medium
              </h4>
              <p className="text-base text-gray-strongText">
                Texto do corpo - Inter Regular com cor strongText
              </p>
              <p className="text-sm text-gray-mutedText">
                Texto pequeno - Inter Regular com cor mutedText
              </p>
              <code className="text-sm font-mono text-gray-strongText bg-gray-muted px-2 py-1 rounded">
                Código inline - JetBrains Mono
              </code>
            </div>
          </div>
        </section>
...
focus:border-accent-border // Borda de foco azul`}</code>
              </pre>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl border border-gray-border p-6">
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    href="/src/theme/README.md"
                    className="text-accent-primary hover:text-accent-primaryHover text-sm"
                  >
                ...
                <li>
                  <a
                    href="/src/theme/components/example-usage.tsx"
                    className="text-accent-primary hover:text-accent-primaryHover text-sm"
                  >
                    Exemplos de Uso
                  </a>
                ...
                <li>
                  <a
                    href="/src/theme/color-examples.tsx"
                    className="text-accent-primary hover:text-accent-primaryHover text-sm"
                  >
                    Exemplos de Cores
                  </a>

...
const GwanMartChatWidget: React.FC<GwanMartChatWidgetProps> = ({
  isOpen,
  onToggle,
  chatbotName,
  chatbotIcon,
  ...
  const { messages, isLoading, sendMessage } = useGwanMartChat(endpoint);
                ...
                <div
                  className={`px-4 py-2 rounded-lg ${
                    message.isUser
                      ...
                      : 'bg-white text-gray-800 border border-gray-200 max-w-md'
                  }`}
                >
                  {message.isUser ? (
...
export default GwanMartChatWidget;

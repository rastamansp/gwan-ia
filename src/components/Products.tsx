...
const Products = () => {
  const products = [
    ...
    {
      title: 'Gwan World Cup',
      description:
        'Gerador de figurinhas no estilo álbum de copa do mundo. Envie uma foto e seus dados pessoais e receba uma figurinha personalizada, com análise de imagem por IA e composição em alta resolução pronta para download.',
      features: [
        'Upload de foto + dados pessoais',
        'Análise de imagem com IA (Claude)',
        'Composição estilo álbum de copa',

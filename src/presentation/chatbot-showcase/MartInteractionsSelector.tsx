...
interface MartInteractionsSelectorProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSelectJourney: (journey: Journey) => void;
}

export const MartInteractionsSelector = ({
  open,
  onOpenChange,
  onSelectJourney,
}: MartInteractionsSelectorProps) => {
  const { journeys } = useMartInteractions();
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            representa um cenário diferente de uso do Gwan Mart.
          </DialogDescription>
        </DialogHeader>

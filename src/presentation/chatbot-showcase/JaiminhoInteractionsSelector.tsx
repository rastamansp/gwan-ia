...
interface JaiminhoInteractionsSelectorProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSelectJourney: (journey: Journey) => void;
}

export const JaiminhoInteractionsSelector = ({
  open,
  onOpenChange,
  onSelectJourney,
}: JaiminhoInteractionsSelectorProps) => {
  const { journeys } = useJaiminhoInteractions();

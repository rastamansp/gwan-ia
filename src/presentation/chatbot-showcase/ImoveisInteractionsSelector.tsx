...
interface ImoveisInteractionsSelectorProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSelectJourney: (journey: Journey) => void;
}

export const ImoveisInteractionsSelector = ({
  open,
  onOpenChange,
  onSelectJourney,
}: ImoveisInteractionsSelectorProps) => {
  const { journeys } = useImoveisInteractions();
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            representa um cenário diferente de uso do Gwan Imóveis.
          </DialogDescription>
        </DialogHeader>
